...
use common::{BlockPosition, Decodable, ReadExtensions, Vector3i, VResult};
...
impl Decodable for BlockPickRequest {
    fn decode(mut buffer: BytesMut) -> VResult<Self> where Self: Sized {
