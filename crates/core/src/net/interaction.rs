...
impl BedrockClient {
    ...
    pub fn handle_container_close(&self, packet: PVec) -> anyhow::Result<()> {
    ...
    pub fn handle_move_player(&self, packet: PVec) -> anyhow::Result<()> {
    ...
    pub fn handle_player_action(&self, packet: PVec) -> anyhow::Result<()> {
