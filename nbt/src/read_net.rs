...
pub fn read_net(stream: &mut BytesMut) -> VResult<Tag> {
...
impl Value {
    fn decode_tag_net(stream: &mut BytesMut) -> VResult<(String, Self)> {
    ...
    fn decode_tag_name_net(stream: &mut BytesMut) -> VResult<String> {
