...
impl Serialize for WorldGenerator {
...
impl Serialize for EducationResourceURI {
    fn serialize<W>(&self, writer: W) -> anyhow::Result<()>
    where
        W: BinaryWrite
    {
...
impl Serialize for ChatRestrictionLevel {
    fn serialize<W>(&self, writer: W) -> anyhow::Result<()>
    where
        W: BinaryWrite
    {
...
impl Serialize for PlayerMovementSettings {
    fn serialize<W>(&self, writer: W) -> anyhow::Result<()>
    where
        W: BinaryWrite
    {
...
impl Serialize for BlockEntry {
        ...
        W: BinaryWrite
    {
        ...
        nbt::to_var_bytes_in(&mut writer, &self.properties)
    }
}
...
impl<'a> Serialize for StartGame<'a> {
        ...
        W: BinaryWrite
    {
        ...
        self.xbox_broadcast_intent.serialize(writer)?;
        self.platform_broadcast_intent.serialize(writer)?;
        ...
        self.chat_restriction_level.serialize(writer)?;
        ...
        self.movement_settings.serialize(writer)?;
