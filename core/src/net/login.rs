...
use util::{BVec, BlockPosition, Deserialize, Vector};
...
impl BedrockUser {
    ...
    pub fn handle_cache_status(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub async fn handle_violation_warning(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub fn handle_local_initialized(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub fn handle_chunk_radius_request(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub fn handle_resource_client_response(&self, packet: BVec) -> anyhow::Result<()> {
        self.expected.store(u32::MAX, Ordering::SeqCst);
    ...
    pub fn handle_client_to_server_handshake(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub async fn handle_login(&self, packet: BVec) -> anyhow::Result<()> {
    ...
    pub fn handle_network_settings_request(&self, packet: BVec) -> anyhow::Result<()> {
