...
/// This should be sent after sending the [`PlayStatus`](crate::bedrock::PlayStatus) packet with a
/// [`LoginSuccess`](crate::bedrock::Status::LoginSuccess) status.
///
/// If the server has no resource packs, a [`ResourcePackStack`](crate::bedrock::ResourcePackStack) packet can be sent immediately after this one
