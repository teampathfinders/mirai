...
fn read_write_var_u32() {
    ...
    let mut buffer = buffer.share();
    assert_eq!(buffer.read_var::<u32>().unwrap(), 45);
    assert_eq!(buffer.read_var::<u32>().unwrap(), 2769);
    assert_eq!(buffer.read_var::<u32>().unwrap(), 105356);
    assert_eq!(buffer.read_var::<u32>().unwrap(), 359745976);
}
...
fn read_write_var_i32() {
    ...
    let mut buffer = buffer.share();
    assert_eq!(buffer.read_var::<i32>().unwrap(), 45);
    assert_eq!(buffer.read_var::<i32>().unwrap(), -2769);
    assert_eq!(buffer.read_var::<i32>().unwrap(), 105356);
    assert_eq!(buffer.read_var::<i32>().unwrap(), -3597459);
}
...
fn read_write_var_u64() {
    ...
    let mut buffer = buffer.share();
    assert_eq!(buffer.read_var::<u64>().unwrap(), 45);
    assert_eq!(buffer.read_var::<u64>().unwrap(), 2769);
    assert_eq!(buffer.read_var::<u64>().unwrap(), 105356);
    assert_eq!(buffer.read_var::<u64>().unwrap(), 359745976);
    assert_eq!(buffer.read_var::<u64>().unwrap(), 35974597639766);
}
